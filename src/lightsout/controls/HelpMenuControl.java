 ...
 */
    ...
    public String displayLightHelp(){
        return "The filled in locations are the on lights, while the empty locations are the \n"
                + "off lights. Once the board is empty all lights are off.";
    }
    
    public String displayBoardHelp(){
        return "The board is set up with letters for the column and numbers for the rows. \n"
    ...
    public String displayPlayerHelp(){
        return "The player is you. Your goal is to have all of the lights on the board set to \n"
    ...
    public String displayRulesHelp(){
        return "Only one light may be selected at a time. Once the light has been selected \n"
